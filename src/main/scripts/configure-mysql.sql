#docker run --name mysqldbfortuttorial -p 3306:3306 -e MYSQL_ALLOW_EMPTY_PASSWORD=yes -d mysql
...
#create database service accounts for using docker
...
#dataabase grants for using docker
